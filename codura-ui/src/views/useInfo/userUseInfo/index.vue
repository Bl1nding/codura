...
<el-row class="charts-row" gutter="20">
    ...
    <el-card class="chart-card" shadow="hover">
        ...
        <WeekUserUseStatusEcharts/>
    </el-card>
</el-col>
<el-col :span="12">
    <el-card class="chart-card" shadow="hover">
    <div slot="header">各活动类型占比</div>
<ActiveUserLeaderboardEcharts :isSingleUser="true"/>
</el-card>
</el-col>
</el-row>
...
<el-row class="active-users-row" gutter="20">
    <el-col :span="24">
    <el-card class="chart-card" shadow="hover">
        <div slot="header">编辑器使用情况</div>
        <!-- 悬浮置顶表格 -->
        <SingleUserEditorUsageTable />
    </el-card>
</el-col>
</el-row>
      <el-row class="active-users-row" gutter="20">
...
<script>
    import WeekUserUseStatusEcharts from '@/components/charts/dayUsePlugInStatusInWeekEcharts.vue'
    ...
    import SingleUserEditorUsageTable from '@/components/charts/SingleUserEditorUsageTable.vue'
    import AiUseInfo from "@/components/charts/aiUseInfo.vue";
    import { autoFormatNumber,autoFormatTime }from '@/utils/xunmeng'
    import {getUserAiUseTime,getUserAiTokenCount,getUserAiUseTimes} from "@/api/uselog/userUseInfo";
